...
export function SettingsPage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <h1 className="ml-10 text-gray-400 text-xl font-bold mt-5">Settings</h1>
      <hr className="w-5/6 mx-auto border-gray-700 my-4" />
      <div className="ml-10">
        <h1 className="text-gray-100 text-xl font-bold">Birth year</h1>
        ...
        <input
          ...
          } bg-gray-900 border-2 w-16 h-8 text-white mt-3 pl-2 rounded-lg appearance-none`}
        ></input>
      </div>
      <hr className="w-5/6 mx-auto border-gray-700 my-4" />
      <div className="ml-10">
        <h1 className="text-gray-100 text-xl font-bold">Blacklist</h1>
        <p className="text-gray-400 text-xs mt-1 font-sans w-4/5">
          Change which websites this extension considers bad
        </p>
        <button className="border-gray-400 border-2 h-8 px-2 rounded-lg text-white mt-3 text-sm hover:border-gray-500 hover:text-gray-500">
          Edit blacklist
        </button>
      </div>
    </div>
